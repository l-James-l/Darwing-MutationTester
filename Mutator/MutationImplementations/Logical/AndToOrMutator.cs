...
public class AndToOrMutator : BaseMutationImplementation
{
    public override SpecificMutation Mutation => SpecificMutation.AndToOr;
    ...
    protected override SyntaxNode SpecificMutationImplementation(SyntaxNode node)
    {
        ...
        {
            return SyntaxFactory.BinaryExpression(SyntaxKind.LogicalOrExpression, binaryExpression.Left, binaryExpression.Right);
        }
