...
public class MultiplyToDivideMutatorTests
{
    private MultiplyToDivideMutator _mutator;

    [SetUp]
    public void SetUp()
    {
        _mutator = new MultiplyToDivideMutator();
    }
    ...
    public void AssertParamsCorrect()
    {
        ...
        Assert.That(_mutator.Mutation, Is.EqualTo(SpecificMutation.MultiplyToDivide));
        Assert.That(_mutator.Kind, Is.EqualTo(SyntaxKind.MultiplyExpression));
        Assert.That(_mutator.RequiredNodeType, Is.EqualTo(typeof(BinaryExpressionSyntax)));
    }

    [Test]
    public void GivenMultiplyNode_WhenMutate_ThenGivesDivideNodeWithSameLeftAndRight()
    {
        //Arrange
        ...
        //Assert
        Assert.That(mutatedNode.Kind, Is.EqualTo(SyntaxKind.DivideExpression));
